...
I'm the co-founder of a tech nonprofit, [SimPPL](https://simppl.org), where we build AI systems to combat public deception influencing elections, health, and policy in 40+ countries. I cofounded [Sakhi](https://sakhi-health.com) to provide reliable health information resulting in improvements in maternal care in rural India and Bangladesh incubated at MIT and UNICEF. I used to be a postdoc at Boston University and MIT building the [Platform Governance Lab](https://truthmarket.com/people). I researched AI-mediated information ecosystems and develop interventions to reduce consumer harms. I got my Ph.D. at NYU Data Science and [CSMAP](https://csmapnyu.org) measuring the effects of cross-platform interventions. I worked on civic integrity at Twitter, recommender systems at Adobe, and product data science at Slack. I'm grateful to Google, Mozilla, Wikimedia, Ford Foundation, Omidyar Network, and the Brown Institute at Columbia for funding my work, among others.

In the past I worked on [production ML systems for particle physics](https://github.com/SwapneelM/DeepJetCore/wiki), prototyping and productionizing a graph-based trending hashtag recommendation for videos, and [graph-based deep learning in physics](https://github.com/SwapneelM/TrackingNtuples)! I've also worked on ML in cybersecurity, [chatbots](https://github.com/SwapneelM/Protobot), and open-source client APIs for IoT ML pipelines. I'm an engineer at heart and a researcher by profession so I enjoy building scalable systems to tackle hard problems!
